...
from backend.utils import enc_iccid, enc_imsi, h2b, rpad, sanitize_iccid
from backend.esim.saip import ProfileElement, ProfileElementSequence
...
class SdKeyScp81_01(SdKey, kvn=0x81): 
    pass
