...
from backend.utils import Hexstr, rpad, enc_plmn, h2i, i2s, s2h
from backend.utils import dec_xplmn_w_act, dec_xplmn, dec_mcc_from_plmn, dec_mnc_from_plmn
...
def dec_st(st, table="sim") -> str:
    ...
    if table == "isim":
        from backend.ts_31_103 import EF_IST_map
        lookup_map = EF_IST_map
    elif table == "usim":
        from backend.ts_31_102 import EF_UST_map
        lookup_map = EF_UST_map
    else:
        from backend.ts_51_011 import EF_SST_map
