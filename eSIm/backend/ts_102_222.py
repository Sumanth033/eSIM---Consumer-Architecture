...
from backend.ts_102_221 import *
...
class Ts102222Commands(CommandSet):
    ...
    delfile_parser.add_argument('--force-delete', action='store_true',
            help='I really want to permanently delete the file. I know backend cannot re-create it yet!')
    ...
    def do_delete_file(self, opts):
        ...
        backend has no support to re-create files yet, and even if it did, your card may not allow it!"""
