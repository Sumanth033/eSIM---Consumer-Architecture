...
from backend.ts_51_011 import EF_ACMmax, EF_AAeM, EF_eMLPP, EF_CMI, EF_PNN
from backend.ts_51_011 import EF_MMSN, EF_MMSICP, EF_MMSUP, EF_MMSUCP, EF_VGCS, EF_VGCSS, EF_NIA
from backend.ts_51_011 import EF_SMSR, EF_DCK, EF_EXT, EF_CNL, EF_OPL, EF_MBI, EF_MWIS
from backend.ts_51_011 import EF_CBMID, EF_CBMIR, EF_ADN, EF_CFIS, EF_SMS, EF_MSISDN, EF_SMSP, EF_SMSS
from backend.ts_51_011 import EF_IMSI, EF_xPLMNwAcT, EF_SPN, EF_CBMI, EF_ACC, EF_PLMNsel
from backend.ts_51_011 import EF_Kc, EF_CPBCCH, EF_InvScan
from backend.ts_102_221 import EF_ARR
from backend.filesystem import *
from backend.ts_31_102_telecom import DF_PHONEBOOK, EF_UServiceTable
from backend.ts_31_103_shared import EF_IMSConfigData, EF_XCAPConfigData, EF_MuDMiDConfigData
from backend.ts_31_103_shared import EF_AC_GBAUAPI, EF_IMSDCI
from backend.cat import SMS_TPDU, DeviceIdentities, SMSPPDownload
...
class EF_SUCI_Calc_Info(TransparentEF):
    ...
    def _decode_hex(self, in_hex):
        ...
        prot_scheme_id_list_len = in_bytes[pos]  
        pos += 1
